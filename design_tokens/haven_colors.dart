...
///
/// When the Flutter project is scaffolded, move this file to `lib/theme/`.
abstract final class HavenColors {
  ...
  static const Color statusInteractive = Color(0xFF3D7BF5);
  ...
  static const Color statusInteractiveBg = Color(0xFFEEF3FE);
