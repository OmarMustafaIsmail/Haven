...
class HavenExperienceState extends State<HavenExperience>
  ...
  Future<void> enterHome() => enterLayer(HavenLayer.home);

  Future<void> enterMoney() => enterLayer(HavenLayer.money);

  Future<void> enterPlans() => enterLayer(HavenLayer.plans);

  Future<void> enterLayer(HavenLayer target) async {
    if (_layer == target || _transitioning) return;
          ...
          child: ListView(
            ...
            children: [
              ...
              HavenLayerBody(
                ...
                onEnterPlans: !transitioning ? onEnterPlans : null,
              ),
            ],
          ),
        );
