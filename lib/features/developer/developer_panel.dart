...
/// Hidden tooling for rapid product validation — not a member-facing surface.
          ...
          _Section(
            ...
            child: Column(
              ...
              children: [
                ...
                _kv('Suppressed', engine.suppressedIds.join(', ').ifEmpty('—')),
                _kv(
                  'Compressed time',
              ...
              children: [
                ...
                _ChipAction(
                  ...
                  onTap: () async {
                    ...
                    _flash(
                      next
                          ? 'Compressed time ON (tick every 30s ≈ +1 day).'
                          : 'Compressed time OFF.',
                    );
                  },
                ),
...
class _ChipAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ActionChip(
      label: Text(label),
      onPressed: onTap,
      backgroundColor: HavenColors.primaryLight,
      labelStyle: HavenTypography.caption.copyWith(
